...
analyzer : 
	ocamlbuild -lflags '-I ~/.opam/4.02.1/lib/ocaml/ unix.cma' -lflags '-I ~/.opam/4.02.1/lib/ocaml/threads/ threads.cma' -cflags '-I ~/.opam/4.02.1/lib/ocaml/' -cflags '-I ~/.opam/4.02.1/lib/ocaml/threads/' -use-ocamlfind -tag thread -package apron,apron.apron,apron.boxD,apron.boxMPFR,apron.boxMPQ,apron.octD,apron.octMPQ,apron.polkaGrid,apron.polkaMPQ,apron.polkaRll,apron.ppl,apron.t1pD,apron.t1pMPFR,apron.t1pMPQ,gmp -use-menhir batman.byte
