...
initial choosing0 == false and choosing1 == false and choosing2 == false and choosing3 == false and choosing4 == false and choosing5 == false and choosing6 == false and choosing7 == false and num0 == 0 and num1 == 0 and num2 == 0 and num3 == 0 and num4 == 0 and num5 == 0 and num6 == 0 and num7 == 0 and x == 0;
...
begin
	while (true) do
		choosing0 = true;
		num0 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6 + num7;
		choosing0 = false;
...
begin
	while (true) do
		choosing1 = true;
		num1 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6 + num7;
		choosing1 = false;
...
begin
	while (true) do
		choosing2 = true;
		num2 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6 + num7;
		choosing2 = false;
...
begin
	while (true) do
		choosing3 = true;
		num3 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6 + num7;
		choosing3 = false;
...
begin
	while (true) do
		choosing4 = true;
		num4 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6 + num7;
		choosing4 = false;
...
begin
	while (true) do
		choosing5 = true;
		num5 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6 + num7;
		choosing5 = false;
...
begin
	while (true) do
		choosing6 = true;
		num6 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6 + num7;
		choosing6 = false;
...
begin
	while (true) do
		choosing7 = true;
		num7 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6 + num7;
		choosing7 = false;
