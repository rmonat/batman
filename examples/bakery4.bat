var choosing0:bool, choosing1:bool, choosing2:bool, choosing3:bool, num0:int, num1:int, num2:int, num3:int, x:int;

initial choosing0 == false and choosing1 == false and choosing2 == false and choosing3 == false and num0 == 0 and num1 == 0 and num2 == 0 and num3 == 0 and x == 0;
