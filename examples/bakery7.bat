var choosing0:bool, choosing1:bool, choosing2:bool, choosing3:bool, choosing4:bool, choosing5:bool, choosing6:bool, num0:int, num1:int, num2:int, num3:int, num4:int, num5:int, num6:int, x:int;

initial choosing0 == false and choosing1 == false and choosing2 == false and choosing3 == false and choosing4 == false and choosing5 == false and choosing6 == false and num0 == 0 and num1 == 0 and num2 == 0 and num3 == 0 and num4 == 0 and num5 == 0 and num6 == 0 and x == 0;
...
begin
	while (true) do
		choosing0 = true;
		num0 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6;
		choosing0 = false;
...
begin
	while (true) do
		choosing1 = true;
		num1 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6;
		choosing1 = false;
...
begin
	while (true) do
		choosing2 = true;
		num2 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6;
		choosing2 = false;
...
begin
	while (true) do
		choosing3 = true;
		num3 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6;
		choosing3 = false;
...
begin
	while (true) do
		choosing4 = true;
		num4 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6;
		choosing4 = false;
...
begin
	while (true) do
		choosing5 = true;
		num5 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6;
		choosing5 = false;
...
begin
	while (true) do
		choosing6 = true;
		num6 = 1 + num0 + num1 + num2 + num3 + num4 + num5 + num6;
		choosing6 = false;
